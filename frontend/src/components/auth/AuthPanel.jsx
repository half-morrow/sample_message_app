  ...
  return (
    <main className="shell">
      <section className="panel auth-panel">
        <h1>サンプル伝言アプリ</h1>
        <div className="tabs">
          <button className={mode === "login" ? "active" : ""} onClick={() => onModeChange("login")}>ログイン</button>
          <button className={mode === "register" ? "active" : ""} onClick={() => onModeChange("register")}>新規作成</button>
        </div>
